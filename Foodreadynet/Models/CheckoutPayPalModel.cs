...
{
    public class CheckoutPayPalModel
    {
        public CheckoutPayPalModel()
        {

            PPScheduleAssistances = new[]
        {
            new SelectListItem{Text="Today",Value="1"},
            new SelectListItem {Text="Tomorrow",Value="2"}
        };
            PPTimeAssistances = new[]
        {
        ...
        [Required(ErrorMessage = "*")]
        [Display(Name = "Street")]
        public string PPAddressLine { get; set; }

        [Display(Name = "Street2")]
        public string PPAddressLine2 { get; set; }
        ...
        public string PPRoomNumber { get; set; }
        ...
        public string PPInstructions { get; set; }

        [Required(ErrorMessage = "*")]
        [Display(Name = "Schedule Date")]
        public string PPScheduleDate { get; set; }

        [Required(ErrorMessage = "*")]
        [Display(Name = "Schedule Time")]
        public string PPScheduleTime { get; set; }

        public ShoppingCart PPCart { get; set; }

        public IEnumerable<SelectListItem> PPScheduleAssistances { get; set; }
        public IEnumerable<SelectListItem> PPTimeAssistances { get; set; }
        public BizInfo PPBizInfo { get; set; }
    }
}