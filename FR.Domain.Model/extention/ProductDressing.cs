...
{
    public partial class ProductDressing : IBaseEntity
    {


        private string _setName = "ProductDressings";
        ...
        public bool IsValid
        {
            get
            {
                if (this.ProductId > 0 & this.DressingId > 0 && this.ExtraDressingPrice >= 0.0m)
                {
                    return true;
                }
                return false;
